...
describe('lib:summarize follows spec', () => {
    ...
    it('keeps spaces before closing spans', () => {
        ...
        tst('<b>Mino Raiola</b><span>, all\'anagrafe </span><b>Carmine Raiola</b>',
            '<b>Mino Raiola</b>, all\'anagrafe <b>Carmine Raiola</b>');
    });
    it('removes really all double spaces, even the ones caused due to unmatched tags', () => {
        // https://de.wikipedia.org/api/rest_v1/page/html/Malta/173025214
        tst('<p>Die <b>Republik Malta</b> (englisch <span>Republic of Malta)</span> ist ein südeuropäischer Inselstaat</p>',
    ...
    it('removes spaces before commas', () => {
        ...
        tst('<b>Darth Vader</b> (some IPA), also',
            '<b>Darth Vader</b>, also');
    });
    it('flattens spans with `&nbsp;` -- removes extra spaces around it, too.', () => {
        tst('<b>Niedersachsen</b> <span>&nbsp;</span>   ist',
            '<b>Niedersachsen</b> ist');
    });
    it('flattens spans with multiple `&nbsp;` -- removes extra spaces around it, too.', () => {
        tst('<b>Niedersachsen</b> <span>&nbsp;</span><span>&nbsp;</span>   ist',
            '<b>Niedersachsen</b> ist');
    });
    ...
    it('removes audio, video, and track tags', () => {
        tst('<p><audio></audio><video><track kind="subtitles"></video></p>',
            '<p></p>');
    });
    it('ignores parens inside attributes by escaping them earlier', () => {
        tst('<p>(Keep me) and this (<img src="latin_paren).jpg"></p>',
            '<p>(Keep me) and this (<img src="latin_paren).jpg" /></p>');
    });
    it('ignores parens inside attributes by escaping them earlier (non-latin parentheses)', () => {
        tst('<p>(Keep me) and this （<img src="non-latin_paren）.jpg"></p>',
            '<p>(Keep me) and this （<img src="non-latin_paren）.jpg" /></p>');
    });
    it('reduces multiple spaces to single space', () => {
        tst('<p>Justice League (both 2017). Justice (is forever)!</p>',
            '<p>Justice League. Justice!</p>');
    });
    it('removes problematic elements including their content', () => {
        tst('.<style>f</style><object>o</object><script>o</script>.',
            '..');
    });
    it('removes unwanted attributes', () => {
        tst('<span bogus="dummy">f</span><b invalid="whateva">o</b>o',
            'f<b>o</b>o');
    });
    it('keeps white-listed attributes', () => {
        tst('<span style="text-align:right">f</span><span class="we-got-class">o</span>o',
            '<span style="text-align:right;">f</span><span class="we-got-class">o</span>o');
    });
    it('removes comments', () => {
        tst('foo<!-- a comment -->bar',
            'foobar');
    });
    it('flattens empty nodes', () => {
        tst('<span></span><b></b><i></i><p><span>f</span></p>',
            '<p>f</p>');
    });
    it('flattens links', () => {
        tst('This is some content with <a href="#"">a link</a>.',
            'This is some content with a link.');
    });
    it('removes .noexcerpt elements', () => {
        tst('This summary should be nice and clean<span class="noexcerpt"> (elements with class "noexcerpt" will be omitted)</span>.',
            'This summary should be nice and clean.');
    });
    it('removes .noprint elements', () => {
        tst('This summary should be nice and clean<span class="noprint"> (elements with class "noprint" will be omitted)</span>.',
            'This summary should be nice and clean.');
    });
    it('keeps sup elements', () => {
        tst('<p>A <b>googolplex</b> is the number 10<sup>googol</sup>, or equivalently, 10<sup>(10<sup>100</sup>)</sup>.</p>',
            '<p>A <b>googolplex</b> is the number 10<sup>googol</sup>, or equivalently, 10<sup>(10<sup>100</sup>)</sup>.</p>');
    });
    it('removes .mw-ref elements', () => {
        tst('<p><b>France</b> is a country with territory status in western Europe and several overseas regions and territories.<sup class="mw-ref" id="cite_ref-twelve_21-0"><a href="#cite_note-twelve-21"><span class="mw-reflink-text">[upper-roman 13]</span></a></sup></p>',
            '<p><b>France</b> is a country with territory status in western Europe and several overseas regions and territories.</p>');
    });
    it('removes .reference elements - T176519', () => {
        tst('<p><b>Charles Milles Manson</b> <sup class="reference nowrap" about="#mwt6" id="mwDQ">:136–7</sup> is an American convicted mass murderer</p>',
            '<p><b>Charles Milles Manson</b> is an American convicted mass murderer</p>');
    });
    it('removes math elements but any math images are shown', () => {
        tst('<p>The Planck–Einstein relation connects the particulate photon energy <span class="texhtml "><i>E</i></span> with its associated wave frequency <span class="texhtml "><i>f</i></span>:</p>\n\n<dl id="mwmQ"><dd id="mwmg"><span class="mwe-math-element"><span class="mwe-math-mathml-inline mwe-math-mathml-a11y" style="display: none;"><math xmlns="http://www.w3.org/1998/Math/MathML">\n  <semantics>\n    <mrow class="MJX-TeXAtom-ORD">\n      <mstyle displaystyle="true" scriptlevel="0">\n        <mi>E</mi>\n        <mo>=</mo>\n        <mi>h</mi>\n        <mi>f</mi>\n      </mstyle>\n    </mrow>\n    <annotation encoding="application/x-tex">{\\displaystyle E=hf}</annotation>\n  </semantics>\n</math></span><img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/f39fac3593bb1e2dec0282c112c4dff7a99007f6" class="mwe-math-fallback-image-inline" aria-hidden="true" style="vertical-align: -0.671ex; width:7.533ex; height:2.509ex;"></span></dd></dl>',
    ...
    it('keeps elements with style="display:none;"', () => {
        // BTW, unneeded spaces are removed but that is just a side-effect we don't care too much about.
        tst('<span style="display: none;">I\'m invisible but still here.</span>',
            '<span style="display:none;">I\'m invisible but still here.</span>');
    });
    it('removes parentheticals', () => {
        tst('Hello world (this is in brackets and will be stripped) and goodnight.',
            'Hello world and goodnight.');
    });
    it('removes multiple parentheticals', () => {
        tst('Hello world (this is in brackets and will be stripped) and (I will also be stripped) goodnight.',
            'Hello world and goodnight.');
    });
    it('keeps parentheticals without spaces', () => {
        tst('Hello world (HW) and goodnight.',
            'Hello world (HW) and goodnight.');
    });
    it('keeps parentheticals without spaces even if there are spaces in the HTML syntax', () => {
    ...
    it('removes nested parentheticals without other characters between the ()', () => {
        tst('<p>Wazz ((listen) this will be removed) up (and this)</p>',
            '<p>Wazz up</p>');
    });
    it('removes nested parentheticals with leading &nbsp; (or space)', () => {
        // The whitespace character is retained.
        // https://es.wikipedia.org/api/rest_v1/page/html/Grecia/105177728
        tst('República Helénica (some IPA)',
            'República Helénica ');
    });
    it('removes trailing spaces after punctuation before closing tag', () => {
        tst('<p>Wazz\'up? </p>',
            '<p>Wazz\'up?</p>');
    });
    it('flattens nested empty spans', () => {
        // Should remove nested empty spans
        tst('Hello (<span><span><span></span></span><span></span></span>) darkness',
            'Hello darkness');
    });
    it('removes some IPAs in nested partentheses', () => {
        tst('<p><b>Azerbaijan</b> (<small>æ(listen)</small> <i>AZ</i>; <span>Azerbaijani:</span><span>  Azərbaycan</span>, officially the <b>Republic of Azerbaijan</b> (Azerbaijani: Azərbaycan Respublikası)), is a country.</p>',
            '<p><b>Azerbaijan</b>, is a country.</p>');
    });
    it('ignores parentheticals inside a data-mw attribute', () => {
        tst('<p><b>Shakira Isabel Mebarak Ripoll</b> (<small data-mw="(t) <!--Arabic (Spanish pronunciation)">pronounced<span>&nbsp;</span></small><span class="IPA"><span>[(t)ʃaˈkiɾa isaˈβel meβaˈɾak riˈpol]</span></span>; <span><span class="ipa_button"></span><span class="nowrap mcs-ipa"><small>English: </small><span class="IPA nopopups noexcerpt"><span>/<span style="border-bottom:1px dotted"><span>ʃ</span><span>ə</span><span>ˈ</span><span>k</span><span>iː</span><span>r</span><span>ə</span></span>/</span></span></span></span>; born 2 February 1977) is a Colombian singer, songwriter, dancer.</p>',
            '<p><b>Shakira Isabel Mebarak Ripoll</b> is a Colombian singer, songwriter, dancer.</p>');
    });
    it('removes content in parentheticals + double spaces', () => {
        tst('<p><b>Epistemology</b> (<span class="nowrap"><span class="IPA nopopups noexcerpt"><span>/<span style="border-bottom:1px dotted"><span title="/ɪ/ or /ə/ \'e\' in \'roses\'">ᵻ</span><span title="/ˌ/ secondary stress follows">ˌ</span><span title="\'p\' in \'pie\'">p</span><span title="/ɪ/ short \'i\' in \'bid\'">ɪ</span><span title="\'s\' in \'sigh\'">s</span><span title="\'t\' in \'tie\'">t</span><span title="/ɪ/ or /ə/ \'e\' in \'roses\'">ᵻ</span><span title="/ˈ/ primary stress follows">ˈ</span><span title="\'m\' in \'my\'">m</span><span title="/ɒ/ short \'o\' in \'body\'">ɒ</span><span title="\'l\' in \'lie\'">l</span><span title="/ə/ \'a\' in \'about\'">ə</span><span title="/dʒ/ \'j\' in \'jam\'">dʒ</span><span title="/i/ \'y\' in \'happy\'">i</span></span>/</span></span><small class="nowrap metadata">&nbsp;(<span class="unicode haudio"><span class="fn"><span style="white-space:nowrap"><span><img alt="About this sound" src="//upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Loudspeaker.svg/11px-Loudspeaker.svg.png" width="11" height="11" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Loudspeaker.svg/17px-Loudspeaker.svg.png 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Loudspeaker.svg/22px-Loudspeaker.svg.png 2x" data-file-width="20" data-file-height="20"></span>&nbsp;</span><span>listen</span></span></span>)</small></span>; from <span>Greek</span> <span lang="gre" xml:lang="gre"><span >ἐπιστήμη</span><i>, epistēmē</i></span>, meaning \'knowledge\', and <span lang="" xml:lang=""><span>λόγος</span><i>, <span>logos</span></i></span>, meaning \'logical discourse\') is the <span>branch</span> of <span>philosophy</span> concerned with the theory of <span>knowledge</span>.</p>',
            '<p><b>Epistemology</b> is the branch of philosophy concerned with the theory of knowledge.</p>');
    });
    it('removes birth and death dates inside parentheticals', () => {
        tst('William Shakespeare (/ˈʃeɪkspɪər/;[1] 26 April 1564 (baptised) – 23 April 1616) was an English poet, playwright, and actor, widely regarded as the greatest writer in the English language and the world\'s pre-eminent dramatist. He is often called England\'s national poet, and the "Bard of Avon". His extant works, including collaborations, consist of approximately 38 plays, 154 sonnets, two long narrative poems, and a few other verses, some of uncertain authorship. His plays have been translated into every major living language and are performed more often than those of any other playwright.',
            'William Shakespeare was an English poet, playwright, and actor, widely regarded as the greatest writer in the English language and the world\'s pre-eminent dramatist. He is often called England\'s national poet, and the "Bard of Avon". His extant works, including collaborations, consist of approximately 38 plays, 154 sonnets, two long narrative poems, and a few other verses, some of uncertain authorship. His plays have been translated into every major living language and are performed more often than those of any other playwright.');
    });
    it('removes parentheticals contain \'*\' symbols', () => {
        tst('Marek Eben (* 18. prosince 1957 Praha) je český herec, moderátor, hudební skladatel, písničkář a zpěvák.',
            'Marek Eben je český herec, moderátor, hudební skladatel, písničkář a zpěvák.');
    });
    it('removes content inside Chinese parentheticals', () => {
        tst('<p><b>台北101</b>（<b>TAIPEI 101</b>）是位於的，樓高509.2米（1,671英尺），樓層共有101層、另有5層，總樓地板面積37萬4千，由設計，團隊、韩国等承造，於1999年動工，2004年12月31日完工啟用；最初名稱為<b>台北國際金融中心</b>（<span lang="en">Taipei World Financial Center</span>），2003年改為現名，亦俗稱為<b>101大樓</b>。興建與經營機構為。其為，曾於2004年12月31日至2010年1月4日間擁有的紀錄，目前為以及環最高，完工以來即成為重要之一。此外，大樓內擁有全球第二大的（僅次）、全球唯二開放遊客觀賞的巨型阻尼器（另一個為上海中心之「上海慧眼」），以及全球起降速度第四快的，僅次於、與。</p>',
    ...
    it('removes content inside Japanese parentheticals', () => {
        tst('<p><b>台湾</b>（たいわん、: <span lang="zh" xml:lang="zh">臺灣 / 台灣</span>、: Tâi-oân）は、のである。</p>',
            '<p><b>台湾</b> は、のである。</p>');
    });
    it('removes content inside Cantonese parentheticals', () => {
        tst('<p><b>蔡英文</b>（<b>Tsai Ing-wen</b>，<a>1956年</a><a>8月31號</a>—）係現任<a>中華民國總統</a>，<a>臺灣</a>學者同埋<a>政治</a>人，<a>民主進步黨</a><a>主席</a>。</p>',
            '<p><b>蔡英文</b> 係現任中華民國總統，臺灣學者同埋政治人，民主進步黨主席。</p>');
    });
    it('removes content inside parentheticals written in `wuu` language variant', () => {
        tst('<p><b>东亚</b>（日文：東アジア ‧ 東亜，韩文：東아시아，西文：Asia Oriental）是一个比较笼统个地理概念，立在弗同个语境当中有弗一样个含义。东亚个概念来自<a>欧洲</a>人对东方个定位，拿<a>博斯普鲁斯海峡</a>、<a class="new">乌拉尔山脉</a>东面个广大欧亚大陆地区侪通称亚洲，拿西太平洋沿岸、欧亚大陆东端个地区就叫做<a class="mw-selflink selflink">东亚</a>。</p>',
    ...
    it('removes content inside parentheticals written in `gan` language variant', () => {
        tst('<p><b>亞細亞洲</b>（古希臘文：Ασία），又簡稱<b>亞洲</b>，絕大部分都位到北半球，係全世界上最大，最多人嗰一隻<a class="mw-redirect">洲</a>。佢東頭一徑到白令海峽嗰傑日尼奧夫角（西經169度40分，北緯60度5分），南頭一徑到努沙登加拉群島（東經103度30分，南緯11度7分），西頭一徑到巴巴角（東經26度3分，北緯39度27分），北頭一徑到切柳斯金角（東經104度18分，北緯77度43分），最高嗰山係<a>珠穆朗瑪峰</a>。亞洲東西嗰時差係11小時。佢西首連到<a>歐洲</a>，箇就係世界上最大嗰大陸-<a class="new">歐亞大陸</a>。</p>',
    ...
    it('keeps parentheticals with single word and leading space inside and out', () => {
        tst('<p>Pilot error was ( sic) the cause of the crash</p>',
            '<p>Pilot error was ( sic) the cause of the crash</p>');
    });
    it('removes parentheticals with multiple words and leading space inside and out', () => {
    ...
    it('reduces multiple spaces to single space', () => {
        tst('<p>The <b>.NET Foundation</b> is an independent organization, incorporated on March 31, 2014,<sup class="mw-ref" id="cite_ref-corp_1-1"><a href="./.NET_Foundation#cite_note-corp-1" style="counter-reset: mw-Ref 1;"><span class="mw-reflink-text">[1]</span></a></sup> by <a href="./Microsoft" title="Microsoft">Microsoft</a>, to improve <a href="./Open-source_software" title="Open-source software">open-source software</a> development and collaboration around the <a href="./.NET_Framework" title=".NET Framework">.NET Framework</a>.<sup class="mw-ref" id="cite_ref-tc2014_4-0"><a href="./.NET_Foundation#cite_note-tc2014-4" style="counter-reset: mw-Ref 4;"><span class="mw-reflink-text">[4]</span></a></sup> It was launched at the annual <a href="./Build_(developer_conference)#2014" title="Build (developer conference)">Build 2014</a> conference held by Microsoft.<sup class="mw-ref" id="cite_ref-msot1_5-0"><a href="./.NET_Foundation#cite_note-msot1-5" style="counter-reset: mw-Ref 5;"><span class="mw-reflink-text">[5]</span></a></sup> The foundation is license-agnostic, and projects that come to the foundation are free to choose any <a href="./Open-source_license" title="Open-source license">open-source license</a>, as defined by the <a href="./Open_Source_Initiative" title="Open Source Initiative">Open Source Initiative</a> (OSI).<sup class="mw-ref" id="cite_ref-faq_6-0"><a href="./.NET_Foundation#cite_note-faq-6" style="counter-reset: mw-Ref 6;"><span class="mw-reflink-text">[6]</span></a></sup> The foundation uses <a href="./GitHub" title="GitHub">GitHub</a> to host the open-source projects it manages.<sup class="mw-ref" id="cite_ref-gh_7-0"><a href="./.NET_Foundation#cite_note-gh-7" style="counter-reset: mw-Ref 7;"><span class="mw-reflink-text">[7]</span></a></sup></p>',
