...
describe('lib:summarize follows spec', () => {
	...
	it('keeps bold elementsa and regular text that contain parentheses', (done) => {
		tst(done, '<p>Foobar <b>(bar)</b></p>', '<p>Foobar <b>(bar)</b></p>');
	});
	it('keeps bold elements that contain parentheses', (done) => {
		tst(done, '<p><b>(Untitled)</b></p>', '<p><b>(Untitled)</b></p>');
	});
	it('keeps bold elements that contain parentheses and single quotes and spaces', (done) => {
		tst(done, "<p>Don't <b>( you've )</b></p>", "<p>Don't <b>( you've )</b></p>");
	});
});
