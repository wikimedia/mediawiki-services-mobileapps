...
function buildSummary(domain, title, html, revTid, meta, siteinfo, processing) {
    ...
    // TODO: Avoid parsing into a full DOM just to get the dc:modified date in cases
    // where the metadata tell us to return EMPTY_EXTRACTS
    return mUtil.createDocument(html)
    .then(doc => buildExtracts(doc, meta, processing)
