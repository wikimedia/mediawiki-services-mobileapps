...
function buildApiUrls(titleObj, domain, meta) {
    const canonicalTitle = titleObj.getPrefixedDBKey();
    return {
        summary: `https://${domain}/api/rest_v1/page/summary/${encodeURIComponent(canonicalTitle)}`,
        // mobile_html: `https://${domain}/api/rest_v1/page/mobile-html/${encodeURIComponent(canonicalTitle)}`,
        metadata: `https://${domain}/api/rest_v1/page/metadata/${encodeURIComponent(canonicalTitle)}`,
        references: `https://${domain}/api/rest_v1/page/references/${encodeURIComponent(canonicalTitle)}`,
        media: `https://${domain}/api/rest_v1/page/media/${encodeURIComponent(canonicalTitle)}`,
        edit_html: `https://${domain}/api/rest_v1/page/html/${encodeURIComponent(canonicalTitle)}`,
        talk_page_html: meta.talkNsText && `https://${domain}/api/rest_v1/page/html/${encodeURIComponent(meta.talkNsText)}:${encodeURIComponent(titleObj.getKey())}`
    };
}
