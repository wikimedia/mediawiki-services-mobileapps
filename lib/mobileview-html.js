...
function getMeta(mwResponse) {
    return BBPromise.resolve({ revision: mwResponse.body.mobileview.revision });
}

function buildPage(mwResponse, processingScript, options) {
    ...
    addPageHeader(document, { parsoid: { meta: {} }, mw: mobileview });
    ...
    return BBPromise.props({
        document: preprocessHtml(document, processingScript, options),
