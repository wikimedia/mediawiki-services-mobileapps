 ...
 */
function runAllSectionsTransforms(doc, deadLinks) {
    var rmSelectors = [
    ...
    hideDeadLinks.hideDeadLinks(doc, deadLinks);
    hideIPA.hideIPA(doc);
 ...
 */
function runParsoidDomTransforms(doc, deadLinks) {
    runAllSectionsTransforms(doc, deadLinks);
