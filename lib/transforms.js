...
transforms.stripUnneededSummaryMarkup = function(doc) {
    stripGermanIPA(doc);
    rmElementsWithSelector(doc, 'figure-inline[data-mw*="target":{"wt":"IPA",]');
    rmElementsWithSelector(doc, 'span[style="display:none"]');
    rmElementsWithSelector(doc, 'span[class*=error]');
