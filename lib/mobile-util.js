...
mUtil.buildContentUrls = function(domain, title, meta) {
    return {
        ...
        talk: meta.talk_ns_text ? `https://${domain}/wiki/${meta.talk_ns_text}:${title.getKey()}` : undefined,
    };
};
...
mUtil.buildApiUrls = function(domain, title, meta) {
    return {
        ...
        talk_page_html: meta.talk_ns_text ? `https://${domain}/api/rest_v1/page/html/${meta.talk_ns_text}:${title.getKey()}` : undefined,
    };
};
