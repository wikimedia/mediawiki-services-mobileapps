...
mUtil.CONTENT_TYPES = {
    html: { name: 'HTML', version: '1.6.0', type: 'text/html' },
    mobileSections: { name: 'mobile-sections', version: '0.13.4', type: 'application/json' },
    media: { name: 'Media', version: '1.0.0', type: 'application/json' },
    readHtml: { name: 'ReadHtml', version: '0.1.0', type: 'text/html' },
    references: { name: 'References', version: '1.0.0', type: 'application/json' },
    metadata: { name: 'Metadata', version: '1.0.0', type: 'application/json' },
    summary: { name: 'Summary', version: '1.3.4', type: 'application/json' },
    definition: { name: 'definition', version: '0.7.4', type: 'application/json' },
    random: { name: 'random', version: '0.6.0', type: 'application/json' },
    announcements: { name: 'announcements', version: '0.1.0', type: 'application/json' },
...
/**
 * Gets the language of the wiki based on the domain.
 * Domains with two or fewer levels are assumed not to have a language subdomain component.
 * Example: 'en.wikipedia.org' -> 'en'
 * Example: 'de.wikipedia.beta.wmflabs.org' -> 'de'
 * Example: 'mediawiki.org' -> undefined
 */
