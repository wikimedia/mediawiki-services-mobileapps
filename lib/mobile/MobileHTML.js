 ...
 */
  ...
  checkElementForThemeExclusion(element, cls) {
    ...
    if (cls && cls.length > 0 && constants.themeExclusionClassRegex.test(cls)) {
  ...
  prepareSectionHeader(header, section, sectionId, isReferenceSection, doc) {
    ...
    if (isReferenceSection) {
      Section.prepareForHiding(doc, sectionId, section, header, this.i18n('article-section-expand'), this.i18n('article-section-collapse'));
    }
    ...
    const button = Edit.newEditSectionButton(doc, sectionId, link, this.i18n('article-edit-button'), this.i18n('article-edit-protected-button'));
