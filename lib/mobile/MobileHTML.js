...
const addDescriptionSourceLeadSection = require('../transformations/pcs/addDescriptionSourceLeadSection');
 ...
 * @param {?Object} mw metadata from MediaWiki
 */
  addMediaWikiMetadata(mw) {
    this.metadata.mw = mw;
    head.addProtectionMetaTags(this.doc, this.metadata);
    addPageHeader(this.doc, this.metadata);
    addDescriptionSourceLeadSection(this.doc, this.metadata);
  }
