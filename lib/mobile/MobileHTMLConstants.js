...
/**
 * @module lib/mobile/MobileHTMLConstants
 */
...
constants.attributesToRemoveFromElements = {
	...
	DIV: ['data-mw', 'typeof'],
	// Don't strip figure 'typeof' since it's part of the css selector
	// FIGURE: ['typeof'],
...
constants.forbiddenDivClassRegex = /(?:^|\s)(?:magnify)(?:\s|$)/;
...
constants.styleOverridingClasses = /(whitebg)/g;
constants.equationBoxElemClassName = 'equation-box-elem';
constants.figcaptionElemClassName = 'figcaption-elem';
constants.notheme = 'notheme';
...
constants.galleryImageClassName = 'gallery-img';
