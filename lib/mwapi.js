...
mwapi.queryForMetadata = (req, query, responseBuilder) => BBPromise.join(
...
mwapi.getMetadataForMobileHtml = (req) => {
    ...
    return mwapi.queryForMetadata(req, query, (page, siteinfo) => {
        return {
...
mwapi.getMetadataForSummary = (req, thumbSize) => {
    ...
    return mwapi.queryForMetadata(req, query, (page, siteinfo, normalizedTitle) => {
