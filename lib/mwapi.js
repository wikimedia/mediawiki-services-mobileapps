...
mwapi.findSharedRepoDomain = function(siteInfoRes) {
    const sharedRepo = (siteInfoRes.body.query.repos || []).find(function(repo) {
...
mwapi.getMetadata = function(app, req) {
    const query = {
        ...
        prop: 'languagecount|thumb|image|id|revision|description|lastmodified|lastmodifiedby|normalizedtitle|displaytitle|protection|editable|namespace|pageprops',
...
mwapi.buildImageUrlSet = function(initialUrl, widths) {
    const match = mwapi.WIDTH_IN_IMAGE_URL_REGEX.exec(initialUrl), result = {};
