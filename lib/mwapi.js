...
mwapi.getSiteInfo = function(app, req) {
    ...
    if (!siteInfoCache[rp.domain]) {
        ...
        siteInfoCache[rp.domain] = api.mwApiGet(app, req.params.domain, query, req.headers)
            .then((res) => {
...
mwapi.queryForMetadata = (app, req, query, responseBuilder) => BBPromise.join(
    ...
    api.mwApiGet(app, req.params.domain, query, req.headers),
    (siteinfo, metadata) => {
...
mwapi.getMainPageData = function(app, req) {
    ...
    return api.mwApiGet(app, req.params.domain, query, req.headers).then((response) => {
...
mwapi.getMostReadMetadata = function(app, req, titlesList) {
    ...
    return api.mwApiGet(app, req.params.domain, query, req.headers);
};
