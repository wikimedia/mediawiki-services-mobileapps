...
const componentsLibCss = `${__dirname}/../pagelib/build/wikimedia-page-library-components.css`;
...
function fetchComponentsLibCss(res) {
    fs.readFile(componentsLibCss, { encoding: 'utf8' }, (err, data) => respond(res, data));
}
