...
/**
 * Encodes an input string so that it can be used as an HTML anchor id (e.g. for a section in a page: <h2 id="anchor">).
 *
 ...
 *
 * @param input the input string (usually the heading text of a section heading)
 * @return the sanitized version of the input string so it can be used as an anchor.
 */
