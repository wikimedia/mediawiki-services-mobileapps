...
function addPageLibJs(document, options) {
    ...
    if (bodyEl) {
      const sections = document.querySelectorAll('html > body > section');
      if (sections.length > 1) {
        const startScript = document.createElement('script');
        startScript.src = `${options.baseURI}data/javascript/mobile/pagelib_body_start`;
      ...
      endScript.src = `${options.baseURI}data/javascript/mobile/pagelib_body_end`;
