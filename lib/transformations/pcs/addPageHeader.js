...
/**
 * @module transformation/pcs/addPageHeader
 */
 ...
 * @param {!string} namespace Namespace of the page, for conditional display of certain elements.
 */
module.exports = (doc, meta, namespace, addADescriptionLabel) => {
	...
	const content = EditTransform.newPageHeader(doc, namespace, meta.mw.displaytitle,
