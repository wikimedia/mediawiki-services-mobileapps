...
/**
 * @module lib/transformations/escapeParens
 */
...
function escape(input) {
	return input.replace(reUnescapedChar, (match) => escapeMap[match]);
}
...
function unescape(input) {
	return input.replace(reEscapedChar, (match) => unescapeMap[match]);
}
