...
function pageJsonPromise(app, req) {
    return getParsoidHtml(app, req)
        .then((response) => {
            ...
            transforms.preprocessParsoidHtml(doc, app.conf.processing_scripts['mobile-sections']);
...
function pageHtmlPromise(app, req, optimized) {
    return getParsoidHtml(app, req)
        .then((response) => {
            ...
            if (optimized) {
                transforms.preprocessParsoidHtml(doc, app.conf.processing_scripts['mobile-html']);
            }
...
function pageHtmlPromiseForReferences(app, req) {
    return getParsoidHtml(app, req)
        .then((response) => {
            ...
            transforms.preprocessParsoidHtml(doc, app.conf.processing_scripts.references);
            return { meta, doc };
        });
}
