 ...
 */
function preprocessedMobileHTMLDocumentPromise(app, res, html, optimized) {
    ...
    .then((doc) => {
        if (optimized) {
            ...
            return MobileHTML.promise(doc, app.conf.processing_scripts['mobile-html'],
 ...
 * @return {!promise} Returns a promise to retrieve the page content from Parsoid
 */
function mobileHTMLDocumentPromise(app, req, optimized) {
    return getParsoidHtml(req)
        .then((res) => {
            return preprocessedMobileHTMLDocumentPromise(app, res, res.body, optimized);
        });
}
...
module.exports = {
    pageJsonPromise,
    mobileHTMLDocumentPromise,
    preprocessedMobileHTMLDocumentPromise,
