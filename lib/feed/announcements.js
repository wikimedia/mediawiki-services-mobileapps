...
function getActiveAnnouncements() {
    const res = [];
    config.androidCountryVariants.forEach(variant => res.push(buildAndroidAnnouncement(variant)));
    config.iOSCountryVariants.forEach(variant => res.push(buildIosAnnouncement(variant)));
    return res;
}
