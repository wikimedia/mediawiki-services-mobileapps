 ...
 */
function hydrateTitle(rbReqTemplate, object, domain) {
 ...
 * @param {!String} domain Domain
 */
function hydrateAllTitles(rbReqTemplate, object, domain) {
    for (const property in object) {
        if (Object.prototype.hasOwnProperty.call(object, property)) {
            if (typeof object[property] === 'object') {
                hydrateAllTitles(rbReqTemplate, object[property], domain);
            } else if (hasTitle(object)) {
                hydrateTitle(rbReqTemplate, object, domain);
            }
        }
    }
}
...
const endResponseWithOutput = (app, res, output, domain, revision) => {
    ...
    hydrateAllTitles(app.restbase_tpl, output, domain);
